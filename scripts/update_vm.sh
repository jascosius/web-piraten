...
sleep 10
rsync -avzr --delete -e "ssh -p 12342" --rsync-path="sudo rsync" --exclude="vm.conf" ~/webpiraten/current/vm/vm/ navigator@chevalblanc.informatik.uni-kiel.de:/home/captain/vm
